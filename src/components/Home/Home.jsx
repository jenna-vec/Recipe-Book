...
export default function Home({ user }) {
  ...
  let Dashboard = () => {
    ...
    useEffect(() => {
      document.title = 'Recipe Book | My Recipes';
    }, []);
    ...
    return (
      <div className='dash'>
        ...
        <Fab className='plus' onClick={(e) => {e.preventDefault(); handleOpen()}} color="primary" aria-label="add" sx={{ alignSelf: "center" }}>
          <AddIcon />
        </Fab>
        <Modal
          open={open}
          ...
          <form onSubmit={(e) => addRecipe(e)}>
            <br />
            <h2 className='petit-cap center'>Add Recipe</h2>
